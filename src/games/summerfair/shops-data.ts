...
export const STORES: SummerStore[] = [
  ...
  { id: 25, name: "רחל כץ מנחת הורים",                 gift: "פייט בוט שעוזר לך להחליט איפה לפרסם – כל אנשי הקשר והפלטפורמות בפרינט ובדיגיטל", color: "#0F4C81", logo: "/summerfair/logos/רחלי שפינגלט.png" },
  ...
  { id: 23, name: "סטודיו מפרש / לאה זינגר",           gift: "5 מתכוני שבת מנצחים מבית מבורכת",                                               color: "#0284C7", logo: "/summerfair/logos/mevorehet.png" },
