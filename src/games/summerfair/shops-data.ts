...
export const STORES: SummerStore[] = [
  ...
  { id: 17, name: "מלכי - מרחב הקואצ'ינג",              gift: "3 מסרים שהמתבגר שלך מקווה שתקלטי בעצמך\n\nכי הוא לא יודע איך לומר לך את זה. 🔐",                                    color: "#B45309", logo: "/summerfair/logos/מרחב הקואצינג100 (1).png" },
