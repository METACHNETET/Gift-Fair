...
export const STORES: SummerStore[] = [
  ...
  { id: 3,  name: "בריאות שיניים",        gift: "תיקח את המתנה מיריד המתנות",                                                    color: "#E879A4", logo: "/summerfair/logos/refuatshinaim.png", alsoInGiftFair: true },
  ...
  { id: 11, name: "שרי וינברג",          gift: "תיקח את המתנה מיריד המתנות",                                                    color: "#9333EA", logo: "/summerfair/logos/smartgo.png", alsoInGiftFair: true },
  ...
  { id: 16, name: "מיכל ניאזוף",         gift: "תיקח את המתנה מיריד המתנות",                                                    color: "#4338CA", logo: "/summerfair/logos/michalnaizof.png", alsoInGiftFair: true },
  ...
  { id: 24, name: "יעל גוטסמן",          gift: MISSING_GIFT,                                                                    color: "#DC2626" },
